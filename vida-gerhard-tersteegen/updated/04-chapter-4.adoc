...
sin embargo, es un gran error considerar cualquier cosa como buena además de Dios,
...
del Padre`". Aunque estos tres apelativos,
...
o no permitirías que ese asunto te afligiera tanto.
...
Cuando ocurre un despertar en cualquier lugar,
